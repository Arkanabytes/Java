...
public class Sighting
{
    ...
    /*Return the type of animal spotted. @return The animal type.*/
    ...
    /*Return how many were spotted. @return The number seen. */
    public int getCount() 
    {
        return count;
    }

    /*Return the ID of the area in which they were seen. @return Where they were seen. */
    public int getArea() 
    {
        return area;
    }
